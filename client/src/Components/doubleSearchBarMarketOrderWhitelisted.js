...
const DoubleSearchBarMarketOrderWhitelisted = ({title1, title2,holder1, holder2, functionToCall,textButton1, textButton2, functionToCall2}) => {
...
export default DoubleSearchBarMarketOrderWhitelisted;